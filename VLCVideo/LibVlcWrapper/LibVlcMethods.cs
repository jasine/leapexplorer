...
namespace LibVlcWrapper
{
    ...
    public static class LibVlcMethods
    {
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_log_subscribe(ref libvlc_log_subscriber sub, IntPtr callback, IntPtr data);

        [MinimalLibVlcVersion("2.1.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_log_subscribe_file(ref libvlc_log_subscriber sub, IntPtr file);

        [MinimalLibVlcVersion("2.1.0")]
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void libvlc_log_unsubscribe(ref libvlc_log_subscriber sub);
